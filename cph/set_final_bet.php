<div class="col-sm-8 col-sm-offset-2">
    <div class="panel panel-primary">
        <div class="panel-body">
            ...
            <p>Mais avant cela, il te faut valider ton inscription au challenge en désignant l'équipe qui, d'après toi, remportera le tournoi <strong>(si tu as trouvé le bon vainqueur final, tu remporteras 6 points bonus à la fin du tournoi)</strong> :</p>
            <form method="post">

<nav class="navbar navbar-light bg-light fixed-top navbar-expand-md" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    <?php if ($_SESSION['service'] == '1' && $_SESSION['actif']) { ?>
                        <a href="ci.php" class="dropdown-item">Saisir un invité</a>
                    <?php } ?>
                    <a href="ci_resultats.php" class="dropdown-item">Consulter les résultats provisoires</a>
                </div>
            </li>
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    if ($_SESSION['actif']) {
                        if ($now > new DateTime('2017-09-01') && $now < new DateTime('2017-10-01')) {
                            ?>
                            <a href="fg_bv.php" class="dropdown-item">Participer au grand vote</a>
                        <?php } ?>
        ...
        <ul class="navbar-nav">
            <li class="nav-item dropdown">
                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">Bonjour <?php echo $_SESSION['prenom']; ?> <span class="badge"><?php echo $mess_nonlus; ?></span> <span class="caret"></span></a>
